...
class JobMatch(Base):
    ...
    decision_reasons = Column(Text, default="")
    hard_filter_passed = Column(Boolean, default=True)
    hard_filter_details = Column(JSON, default=list)
    user_confirm_required = Column(JSON, default=list)
    application_strategy = Column(Text, default="")
