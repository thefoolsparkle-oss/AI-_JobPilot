...
export default function AssistantPage() {
  ...
  if (!loaded) {
    fetch(`${API_BASE}/jobs`).then(r => r.json()).then(setJobs).catch(console.error).finally(() => setLoaded(true));
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="bg-white rounded-xl border border-zinc-200 p-6 mb-6">
        <div className="mb-4">
          <label className="block text-sm font-medium text-zinc-600 mb-1">关联岗位（可选，提高回答准确度）</label>
